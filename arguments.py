...
parser.add_argument('-b', '--batches', nargs=1, default=[100], type=int, help='The amount of batches to train on per epoch')
...
parser.add_argument('--batch-size', nargs=1, default=[None], type=int, help='The absolute number of samples in a single batch')
parser.add_argument('--save-pickle', action='store_true', default=False, help='Stores predicted images as pickles')
